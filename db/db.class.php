	...
	class DBConnection
	{
		...
		public static function Update($query,$params)
		{
			...
			else
			{
				...
				$affectedRows = $stmt->affected_rows; // Gets the number of affected rows in a previous MySQL operation,eturns the number of rows affected by the last INSERT, UPDATE, REPLACE or DELETE query.
				$stmt->close();
			}
